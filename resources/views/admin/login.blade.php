...
<head>
    ...
    <style>
        ...
        .login-main .login-bottom .center .item .icon-1 {
            background: url({{ $layuiminiUrl }}/images/icon-login.png) no-repeat 1px 0;
        }

        .login-main .login-bottom .center .item .icon-2 {
            background: url({{ $layuiminiUrl }}/images/icon-login.png) no-repeat -54px 0;
        }

        .login-main .login-bottom .center .item .icon-3 {
            background: url({{ $layuiminiUrl }}/images/icon-login.png) no-repeat -106px 0;
        }

        .login-main .login-bottom .center .item .icon-4 {
            background: url({{ $layuiminiUrl }}/images/icon-login.png) no-repeat 0 -43px;
            position: absolute;
            right: -10px;
            cursor: pointer;
        }
        ...
        .login-main .login-bottom .center .item .icon-5 {
            background: url({{ $layuiminiUrl }}/images/icon-login.png) no-repeat -55px -43px;
        }

        .login-main .login-bottom .center .item .icon-6 {
            background: url({{ $layuiminiUrl }}/images/icon-login.png) no-repeat 0 -93px;
            position: absolute;
            right: -10px;
            margin-top: 8px;
            cursor: pointer;
        ...
        .login-main .login-bottom .tip .icon-check {
            ...
            height: 14px;
            border: none;
            background: url({{ $layuiminiUrl }}/images/icon-login.png) no-repeat -111px -48px;
        }
        ...
        body {
            background: url({{ $layuiminiUrl }}/images/loginbg.png) 0% 0% / cover no-repeat;
            position: static;
            font-size: 12px;
        }
...
<div class="footer">
    ©版权所有 xxx<span class="padding-5">|</span><a target="_blank" href="#">xxx</a>
</div>
...
<script>
    layui.use(['form', 'jquery'], function () {
        ...
        form.on('submit(login)', function (data) {
            ...
            data.keep = $('.icon-nocheck').hasClass('icon-check') ? 1 : 0;
